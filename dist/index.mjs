...
var GenApiChatResponseSchema = z2.object({
...
var createGenApiChatChunkSchema = (errorSchema) => z2.union([
  z2.object({
    id: z2.string().nullish(),
    created: z2.number().nullish(),
    model: z2.string().nullish(),
...
var genApiCompletionResponseSchema = z3.object({
...
var createGenApiCompletionChunkSchema = (errorSchema) => z3.union([
  z3.object({
    id: z3.string().nullish(),
    created: z3.number().nullish(),
    model: z3.string().nullish(),
